...
- [AI Tool](#ai-tool)
  - [overview](#overview)
    - [AI Code benchmark](#ai-code-benchmark)
    - [AI Secure Code benchmark](#ai-secure-code-benchmark)
    - [AI快速阅读论文](#ai快速阅读论文)
...
### AI Secure Code benchmark

1. SyberSecEval:

   1. ask to generate same function code and check the CWE
   ...
   3. Methodology:
      ...
      1. Data Collection: Prompt + MODEL (1916 Prompts)
      2. Analysis: SAST (SemGrep) + RegEx Combinations
...
2. CWEEval:
   ...
   2. Scope
      1. 119 Coding Tasks
         1. 31 CWEs
         2. 5 Languages
         3. Well defined function signature and instructions
   3. Methodology:
      1. Data Collection:
         1. Prompt w/ func signature + instructions
         2. Parse + Repair
      2. Analysis: DAST
         1. Functional Test Oracles
         2. Security Test Oracles

3. BaxBench:
   1. ask to generate code with framework reference, run and check
   2. Scope:
   3. 392 BackEnd Coding Tasks
      1. 28 Coding Scenarios [S] (ex: Shopping Cart Rest API)
      2. 14 BackEnd Frameworks [B] (ex: Django)
      3. 6 Languages [L] (ex: Python)
   4. Methodology:
      1. Data Collection:
         1. Prompt w/ OpenAPI Spec for each S-F-L
         2. Parse + Repair (single-file vs multi-file)
      2. Analysis:
         1. Compilation
         2. Dynamic container image creation + spawn
         3. DAST:
            1. Functional correctness
            2. Security (exploits/payloads)
