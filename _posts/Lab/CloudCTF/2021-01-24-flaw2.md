...
This next level is running as a container at https://container.target.flaws2.cloud/.
...
- https://container.target.flaws2.cloud/proxy/https://flaws.cloud
- or https://container.target.flaws2.cloud/proxy/https://neverssl.com
...
2. In the query editor, run:
   - <img alt="pic" src="https://i.imgur.com/LVDAv9T.png" width="400">
...
3. Switch to the flaws2 database just created and run:
   - <img alt="pic" src="https://i.imgur.com/PYHebTN.png" width="600">
...
4. now run:
   - <img alt="pic" src="https://i.imgur.com/iigAbZS.png" width="600">
