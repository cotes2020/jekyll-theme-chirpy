...
## Summary
In this post, I showed how a Hypothesis Test can be devised to account for the sequence of data. Other techniques exist to do this like the [Sequential Probability Ratio Test](https://en.wikipedia.org/wiki/Sequential_probability_ratio_test), although with a different Null Distribution. The Interval Detector has worked well in practice and better aligns with expectations from engineering teams. The [`IntervalDetectorModel`](https://github.com/facebookresearch/Kats/blob/9908d375ff316ea2b354e26a637ac4f2f47dc25a/kats/detectors/interval_detector.py#L364) implements this post and more, allowing your desired FWER to a specific $$\alpha$$ to use when conducting the test.