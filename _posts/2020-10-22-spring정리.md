...
```
MVC 디자인패턴을 통해 웹애플리케이션의 Model, View, Controller 사이의 의존관계를

DI 컨테이너에서 개발자가 아닌 서버가 객체들을 관리하는 웹 애플리케이션 구축
```
...
예를 들어 JPA를 사용할 때 Spring JPA를 사용하여 추상화하므로

실제구현에 있어서 Hibernate를 사용하든 EclipseLink를 사용하든
...
![](/assets/img/1022_spring/blog_imgs/spring_framework_modules.gif)
...
![](/assets/img/1022_spring/blog_imgs/spring_total_app.png)

<br>

### Spring 웹 애플리케이션

![](/assets/img/blog_imgs/1022_spring/spring_web.png)

<br>

### Spring MVC

![](/assets/img/blog_imgs/1022_spring/spring_mvc.png)
