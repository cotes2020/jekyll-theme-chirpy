...
- [SQL Syntax](#sql-syntax)
  ...
  - [4.1.1. Identifiers and Key Words](#411-identifiers-and-key-words)
    - [SQL identifiers and key words](#sql-identifiers-and-key-words)
    - [second kind of identifier: delimited/quoted identifier](#second-kind-of-identifier-delimitedquoted-identifier)
  - [4.1.2. Constants](#412-constants)
    - [4.1.2.1. String Constants `'It''s a string'`](#4121-string-constants-its-a-string)
    - [4.1.2.2. Dollar-Quoted String Constants](#4122-dollar-quoted-string-constants)
    - [4.1.2.3. Bit-String Constants](#4123-bit-string-constants)
    - [4.1.2.4. Numeric Constants](#4124-numeric-constants)
    - [4.1.2.5. Constants of Other Types](#4125-constants-of-other-types)
  - [4.1.3. Operators](#413-operators)
  - [4.1.4. Special Characters](#414-special-characters)
  - [4.1.5. Comments](#415-comments)
  - [4.1.6. Lexical Precedence](#416-lexical-precedence)
