...
A Tree is an undirected, connected, acyclic graph 无向的、连通的、无环图
...
4. Like Linked Lists and unlike Arrays, Trees dont have an upper limit on number of nodes as nodes are linked using pointers.
