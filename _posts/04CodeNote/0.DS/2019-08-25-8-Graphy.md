...
- [pythonds3 - 8. Graphs and Graph Algorithms](#pythonds3---8-graphs-and-graph-algorithms)
  ...
  - [stirring up a batch of pancakes: Topological 拓扑 Sorting](#stirring-up-a-batch-of-pancakes-topological-拓扑-sorting)
  - [Strongly Connected Components](#strongly-connected-components)
    - [for web pages: strongly connected components algorithm (SCC)](#for-web-pages-strongly-connected-components-algorithm-scc)
...
## stirring up a batch of pancakes: Topological 拓扑 Sorting
...
- To help us decide the `precise order` in which we should do each of the steps required to make our pancakes we turn to a graph algorithm called the **topological sort** 拓扑
...
### for web pages: strongly connected components algorithm (SCC)
