...
we find 2 endpoints, `admin` and `admin_101`. 

# sqli db dump

when we visit the /admin_101 endpoint we see that the email is already set and in the source code the page actually sends the post request :
