...
- [Data Structures - Basic 1 - Data Structures Tree](#data-structures---basic-1---data-structures-tree)
  - [Type](#type)
  ...
  - [Tree **Interface**](#tree-interface)
    - [Tree Abstract Data Type](#tree-abstract-data-type)
    - [AbstractTree **class**](#abstracttree-class)
  - [Binary Tree **interface**](#binary-tree-interface)
      - [Binary Tree Abstract Data Type](#binary-tree-abstract-data-type)
      - [AbstractBinaryTree **class**](#abstractbinarytree-class)
        ...
        - [Relating Internal Nodes to External Nodes in a Proper Binary Tree](#relating-internal-nodes-to-external-nodes-in-a-proper-binary-tree)
    - [Implementing Trees](#implementing-trees)
      - [Linked Binary Tree Structure **class** (Linked Structure for Binary Trees)](#linked-binary-tree-structure-class-linked-structure-for-binary-trees)
      - [Linked Binary Tree Structure **class** (Array-Based Structure for Binary Trees)](#linked-binary-tree-structure-class-array-based-structure-for-binary-trees)
      - [Linked Structure for General Trees](#linked-structure-for-general-trees)
    - [Types of BT](#types-of-bt)
      - [Full Binary Tree 要么有要么没](#full-binary-tree-要么有要么没)
      - [Perfect Binary Tree](#perfect-binary-tree)
      - [Complete Binary Tree](#complete-binary-tree)
      - [Balanced Binary Tree](#balanced-binary-tree)
      - [degenerate / pathological tree](#degenerate--pathological-tree)
- [Tree Traversal Algorithms: visiting the positions of a tree](#tree-traversal-algorithms-visiting-the-positions-of-a-tree)
  - [Preorder and Postorder Traversals of General Trees](#preorder-and-postorder-traversals-of-general-trees)
    - [preorder traversal `N-L-R` **General** **Visit() -> each child preorder(c)**](#preorder-traversal-n-l-r-general-visit---each-child-preorderc)
      - [preorder in java](#preorder-in-java)
      - [preorder in python](#preorder-in-python)
    - [postorder traversal `L-R-N` **General** **Each child preorder(c) -> Visit()**](#postorder-traversal-l-r-n-general-each-child-preorderc---visit)
      - [postorder in java](#postorder-in-java)
      - [postorder in python](#postorder-in-python)
  - [BFS and DFS](#bfs-and-dfs)
    - [BFS - Breadth-First Tree Traversal **General** **Queue()**](#bfs---breadth-first-tree-traversal-general-queue)
      - [BFS Pseudocode](#bfs-pseudocode)
      - [BFS in Java](#bfs-in-java)
  - [inorder traversal `L-N-R` **Binary tree**](#inorder-traversal-l-n-r-binary-tree)
    - [Pseudocode](#pseudocode)
    - [inorder in java](#inorder-in-java)
    - [inorder in python](#inorder-in-python)
    - [application](#application)
      - [BST - Binary Search Trees 左小右大](#bst---binary-search-trees-左小右大)
        - [Implementing Tree Traversals in Java](#implementing-tree-traversals-in-java)
        - [Preorder Traversals](#preorder-traversals)
        - [Postorder Traversal](#postorder-traversal)
        - [Inorder Traversal](#inorder-traversal)
        - [Implementing Tree Traversals in Python](#implementing-tree-traversals-in-python)
        - [Search Tree Analysis `𝑂(log2𝑛) to 𝑂(𝑛)`](#search-tree-analysis-𝑂log2𝑛-to-𝑂𝑛)
  - [Applications of Tree Traversals](#applications-of-tree-traversals)
    - [Table of Contents](#table-of-contents)
      - [preorder 1 `N-L-R`](#preorder-1-n-l-r)
      - [preorder 2 `N-L-R`](#preorder-2-n-l-r)
    - [Computing Disk Space `postorder L-R-N`](#computing-disk-space-postorder-l-r-n)
    - [Parenthetic Representations of a Tree](#parenthetic-representations-of-a-tree)
    - [Using Inorder Traversal for Tree Drawing](#using-inorder-traversal-for-tree-drawing)
    - [Euler Tours](#euler-tours)
      - [pseudocode](#pseudocode-1)
  - [Balanced Binary Search Trees](#balanced-binary-search-trees)
    - [AVL Tree Performance](#avl-tree-performance)
  ...
  - [check Height Of Binary Tree](#check-height-of-binary-tree)
