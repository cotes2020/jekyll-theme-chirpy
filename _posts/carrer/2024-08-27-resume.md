...
## 엘지 채용사이트(LG Careers) 개발 `2025.01 - 2026.04`

- 주관사 : 엘지에너지솔루션
- 수행사 : LG CNS
- 소속 : 두드림테크
- 팀구성 : 20명 이상
- 사용기술 : Typescript, Vue.js, Vite, Nuxt.js, Git, 
- 주요업무 : 임직원몰 SaaS형 커머스 사이트 SI성 개발, 기존 프론트 프레임워크 버전 업 마이그레이션 
1. 셀프개통, 휴대폰구매, 바코드 결제 등 신규 기능 추가 개발
2. Nuxt2 -> Nuxt3 마이그레이션. 웰컴사이트, 커머스, 관리자 사이트 총 3개 사이트 마이그레이션 주도 개발.
3. Nuxt -> Next 로 프론트 프레임워크 전환 프로젝트 설계 및 주도 : Cursor, Clude 등 개발용 AI 기반 코딩 도구 활용
