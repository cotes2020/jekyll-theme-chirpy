...
description: In this article, I will show you a very useful exploit that allows you to perform a privilege escalation in a Windows environment. From an unprivileged user to nt autority\system.
...
## Usage
As I write this article, 3 methods have been developed for KrbRelayUp:
...
As you can see, I'm a basic domain user without any Administrator privilege:
...
Don't worry! KrbRelayUp has your back with the `--sc` option. 
