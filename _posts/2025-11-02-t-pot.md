...
---
T-pot is a multi honeypot platform that runs over 20 different honeypots and sends everything into the Elastic Stack so you can visualize attacks in real time. In this guide I walk through how I set up my deployment and added some small tweaks. The goal of this project is to collect real attack data, study what hits the server, and build some threat hunting experience from live internet traffic.
...
I'll be doing a Part 2 on this, showing what I've gathered at 3 million attacks while running t-pot 24/7, highlighting interesting findings, and demonstrating some threat hunting techniques. 
