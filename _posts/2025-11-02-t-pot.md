...
---
T-Pot is an all-in-one honeypot stack that spins up 20+ services and ships everything into the Elastic Stack for instant dashboards. In this post I deploy T-Pot on Ubuntu cloud vm, and make it believable with some Cowrie tweaks. If you want your own live attack lab for research, I reccomend this guide.
...
```
![](https://i.postimg.cc/mDnDc5HP/hour.webp)
