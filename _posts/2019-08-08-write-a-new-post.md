...
Starting from _Chirpy v5.2.0_, the property for the preview image changes from `image.src` to `image.path`. If upgrading the theme from a prior version, you will have to update posts' metadata to use new image property.
