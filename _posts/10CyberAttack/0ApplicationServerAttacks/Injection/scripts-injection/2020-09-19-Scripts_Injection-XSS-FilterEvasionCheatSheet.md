---
title: Meow's CyberAttack - Application/Server Attacks - Scripts Injection - Cross Site Scripting Filter Evasion Cheat Sheet
# author: Grace JyL
...
- [Cross Site Scripting Filter Evasion Cheat Sheet](#cross-site-scripting-filter-evasion-cheat-sheet)
- [SEED Labs – Cross-Site Scripting Attack Lab](#seed-labs--cross-site-scripting-attack-lab)
  - [Posting a Malicious Message to Display an Alert Window](#posting-a-malicious-message-to-display-an-alert-window)
  - [stealing cookie](#stealing-cookie)
  - [Session Hijacking using the Stolen Cookie](#session-hijacking-using-the-stolen-cookie)
    - [GET with XSS - add friend](#get-with-xss---add-friend)
    - [POST with Js - modify profile](#post-with-js---modify-profile)
    - [Writing an XSS worm](#writing-an-xss-worm)
    - [self-propagation](#self-propagation)
- [XSS Filter Evasion Cheat Sheet](#xss-filter-evasion-cheat-sheet)
  - [use `query`](#use-query)
  - [navigates the user's browser to a different URL](#navigates-the-users-browser-to-a-different-url)
  - [find different tag to use](#find-different-tag-to-use)
  - [strips out word `javascript`](#strips-out-word-javascript)
  - [strips out word `onReadyStateChange`](#strips-out-word-onreadystatechange)
  - [Basic XSS Test Without Filter Evasion](#basic-xss-test-without-filter-evasion)
  - [XSS Locator (Polygot)](#xss-locator-polygot)
  - [Image XSS Using the JavaScript Directive](#image-xss-using-the-javascript-directive)
  - [No Quotes and no Semicolon](#no-quotes-and-no-semicolon)
  - [Case Insensitive XSS Attack Vector](#case-insensitive-xss-attack-vector)
  - [HTML Entities](#html-entities)
  - [Grave Accent Obfuscation](#grave-accent-obfuscation)
  - [Malformed A Tags](#malformed-a-tags)
  - [Malformed IMG Tags](#malformed-img-tags)
  - [fromCharCode](#fromcharcode)
  - [`Default SRC Tag` to Get Past Filters that Check SRC Domain](#default-src-tag-to-get-past-filters-that-check-src-domain)
  - [`Default SRC Tag` by Leaving it Empty](#default-src-tag-by-leaving-it-empty)
  - [Default SRC Tag by Leaving it out Entirely](#default-src-tag-by-leaving-it-out-entirely)
  - [On Error Alert](#on-error-alert)
  - [IMG onerror and JavaScript Alert Encode](#img-onerror-and-javascript-alert-encode)
  - [Decimal HTML Character References](#decimal-html-character-references)
  - [Decimal HTML Character References Without Trailing Semicolons](#decimal-html-character-references-without-trailing-semicolons)
  - [Hexadecimal HTML Character References Without Trailing Semicolons](#hexadecimal-html-character-references-without-trailing-semicolons)
  - [Embedded Tab](#embedded-tab)
  - [Embedded Encoded Tab](#embedded-encoded-tab)
  - [Embedded Newline to Break-up XSS](#embedded-newline-to-break-up-xss)
  - [Embedded Carriage Return to Break-up XSS](#embedded-carriage-return-to-break-up-xss)
  - [Null breaks up JavaScript Directive](#null-breaks-up-javascript-directive)
  - [Spaces and Meta Chars Before the JavaScript in Images for XSS](#spaces-and-meta-chars-before-the-javascript-in-images-for-xss)
  - [Non-alpha-non-digit XSS](#non-alpha-non-digit-xss)
  - [Extraneous Open Brackets](#extraneous-open-brackets)
  - [No Closing Script Tags](#no-closing-script-tags)
  - [Protocol Resolution in Script Tags](#protocol-resolution-in-script-tags)
  - [Half Open HTML/JavaScript XSS Vector](#half-open-htmljavascript-xss-vector)
  - [Double Open Angle Brackets](#double-open-angle-brackets)
  - [Escaping JavaScript Escapes](#escaping-javascript-escapes)
  - [End Title Tag](#end-title-tag)
  - [INPUT Image](#input-image)
  - [BODY Image](#body-image)
  - [IMG Dynsrc](#img-dynsrc)
  - [IMG Lowsrc](#img-lowsrc)
  - [List-style-image](#list-style-image)
  - [VBscript in an Image](#vbscript-in-an-image)
  - [Livescript (older versions of Netscape only)](#livescript-older-versions-of-netscape-only)
  - [SVG Object Tag](#svg-object-tag)
  - [ECMAScript 6](#ecmascript-6)
  - [BODY Tag](#body-tag)
  - [Event Handlers](#event-handlers)
  - [\& JavaScript includes](#-javascript-includes)
  - [STYLE sheet](#style-sheet)
  - [Remote style sheet](#remote-style-sheet)
  - [Remote style sheet part 2](#remote-style-sheet-part-2)
  - [Remote style sheet part 3](#remote-style-sheet-part-3)
  - [Remote style sheet part 4](#remote-style-sheet-part-4)
  - [STYLE Tags with Broken-up JavaScript for XSS](#style-tags-with-broken-up-javascript-for-xss)
  - [STYLE Attribute using a Comment to Break-up Expression](#style-attribute-using-a-comment-to-break-up-expression)
  - [IMG STYLE with Expression](#img-style-with-expression)
  - [Anonymous HTML with STYLE Attribute](#anonymous-html-with-style-attribute)
  - [Local htc File](#local-htc-file)
  - [DIV Background-image Plus Extra Characters](#div-background-image-plus-extra-characters)
