...
last_modified_at: 2026-02-22. 18:46 # E +MVP 설명
...
- 사용자에게 객체의 어떤 정보가 어떻게, 어디에 보여져야 하는가? -> UX
...
- 사용자와 시스템이 어떻게 인터랙션 해야 하는가? (Event Handler, Presenter 등)
