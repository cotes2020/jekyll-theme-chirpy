...
| .          | $ rpm -K mc.rpm *<font color=OrangeRed> <-- check signiture </font>*                                                                                                    |
...
| .          | $ sudo yum createrepo . *<font color=OrangeRed> <-- each time add rpm </font>*                                                                                          |
| .          | $ sudo yum clean all                                                                                                                                                    |
...
| .          | module(load="imtcp") input(type="imtcp" port="514") *<font color=OrangeRed> <-- uncommand </font>*                                                |
