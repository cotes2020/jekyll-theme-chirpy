...
1. a <font color=OrangeRed> monitoring service for AWS cloud resources and the applications </font> run on AWS.
   - a repository for <font color=OrangeRed> metric data </font>
...
3. Permission:
   ...
   - The unified <font color=OrangeRed> CloudWatch Agent </font>
...
4. <font color=OrangeRed> Monitors, Collects and tracks </font>
   ...
   - monitors AWS resources and the applications run on AWS <font color=OrangeRed> in real time </font>
   ...
   - Example:
     ...
     - EC2
       - By default, EC2 provides <font color=LightSlateBlue> basic monitoring </font>, sends metric data to CloudWatch in 5-minute periods.
       - To send metric data for your instance to CloudWatch in 1-minute periods, enable <font color=LightSlateBlue> detailed monitoring </font> on the instance.
...
6. gain <font color=OrangeRed> system-wide visibility </font> about
   - resource use,
...
8. produce metrics, and these are <font color=OrangeRed> time-ordered </font> sets of data.

5. <font color=OrangeRed> Turns metrics into statistics </font> to be used by CloudWatch alarms
...
7. Events
   - use CloudWatch Events to define rules
     ...
     - <font color=LightSlateBlue> if a rule is matched, can take corrective action as necessary </font>
   - Targets:
   ...
   - 2 options when creating a rule.
     - invoke a target <font color=LightSlateBlue> by its event patterns </font>
     - invoke a target <font color=LightSlateBlue> by a schedule </font>
...
9.  Alarms and action
    - key components of a CloudWatch alarm
      ...
      - <font color=LightSlateBlue> thresholds </font>
        - create alarms based on:
          - static thresholds
          - anomaly detection.
          - metric math expression
      - <font color=LightSlateBlue> metrics </font>
        - measured data points over time.
      - <font color=LightSlateBlue> action </font>
        - action can produce an email or even work in conjunction with Auto Scaling groups.
      - <font color=LightSlateBlue> period </font> :
         - period is related to its threshold.
         - the length of time in which a threshold is surpassed before an alarm is generated.
    - can be <font color=LightSlateBlue> configured with alarms to take actions </font>
    - <font color=LightSlateBlue> actions can be used to trigger services </font>
    ...
    - <font color=LightSlateBlue> create alarms on </font>
      ...
      - <font color=LightSlateBlue> custom metrics </font> that specific to the custom applications or infrastructure.
...
2. log stream
   - a sequence of <font color=LightSlateBlue> log events with the same source </font>
