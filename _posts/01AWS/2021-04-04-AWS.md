...
- a guide, designed to help you build the most secure, high-performing, resilient, and efficient infrastructure for cloud applications and workloads.
- It provides a set of foundational questions and best practices to evaluate and implement cloud architectures.
...
- Stop guessing capacity needs.
	⁃	use as much or as little capacity as you need, and scale up or down automatically.
...
- Drive architectures using data.
	...
	⁃	use that data to inform your architectural choices and improvements over time
...
- Reliability
	...
	⁃	AWS Config track the configuration state of your resources and how the state has changed over time.
