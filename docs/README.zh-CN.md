...
[![Devices Mockup](https://cdn.jsdelivr.net/gh/cotes2020/chirpy-assets/img/commons/devices-mockup.png)](https://chirpy.cotes.info)
...
2. 回到 GitHub 上的仓库， 通过 _Settings_
 → _Options_ → _GitHub Pages_ 选择分支 `gh-pages` 作为[_发布源_](https://docs.github.com/en/github/working-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site):
    ![gh-pages-sources](https://cdn.jsdelivr.net/gh/cotes2020/chirpy-assets/img/posts/20190809/gh-pages-sources.png)
