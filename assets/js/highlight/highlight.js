...
/*! `bash` grammar compiled for Highlight.js 11.9.0 */
  ...
  */
  ...
  return yaml;
    ...
    hljs.registerLanguage('yaml', hljsGrammar);
  })(); /*! `dax` grammar compiled for Highlight.js 11.9.0 */
  (function(){
    var hljsGrammar = (function () {
  'use strict';
  ...
  */
  ...
  function dax(hljs) {
    ...
    return {
      ...
      case_insensitive: true,
      keywords: {
        $pattern: /\b[\w\.]+/, //TODO update so it doesn't highlight text within measures. Look at SQLBIs code
        keyword: KEYWORDS,
        built_in: FUNCTIONS, //TODO function()
        type: TYPES
      },
      contains: [
        hljs.COMMENT('--', '$'),
