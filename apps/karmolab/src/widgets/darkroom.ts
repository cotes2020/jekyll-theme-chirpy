    ...
    tabs: [
      {
        ...
        build: function (container: HTMLElement): void {
          ...
          container.innerHTML = `
                ...
                `;
          const canvasEl = container.querySelector('#darkCanvas') as HTMLCanvasElement | null;
          const areaEl = container.querySelector('#darkArea') as HTMLElement | null;
          const doorEl = container.querySelector('#escapeDoor') as HTMLElement | null;
          const winBoxEl = container.querySelector('#darkWin') as HTMLElement | null;
          const resetEl = container.querySelector('#resetDark') as HTMLButtonElement | null;
          if (!canvasEl || !areaEl || !doorEl || !winBoxEl || !resetEl) return;
          ...
          area.onmousemove = (e: MouseEvent) => {
            ...
            door.style.opacity = dist < 50 ? String(1 - dist / 50) : '0';
          };
          ...
          function animate(): void {
            c2d.fillStyle = '#010101';
            c2d.fillRect(0, 0, canvas.width, canvas.height);
            c2d.save();
            c2d.globalCompositeOperation = 'destination-out';
            c2d.beginPath();
            c2d.arc(mx, my, 40, 0, Math.PI * 2);
            c2d.fill();
            c2d.restore();
