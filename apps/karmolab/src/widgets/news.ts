    ...
    tabs: [
      {
        ...
        build: function (container: HTMLElement): void {
          ...
          const article =
            "오늘 낮, 익명의 집사가 고양이 간식을 훔쳐 먹은 것으로 밝혀져 충격을 주고 있습니다. 고양이 측 대변인은 '믿었던 집사에게 발등을 찍혔다'며 강하게 규탄했습니다. 이에 대해 집사 측은 '너무 맛있어 보여서 그만...' 이라며 말끝을 흘렸습니다. 한편, 이 소식을 접한 옆 동네 강아지는 '그럴 줄 알았다'며 냉소적인 반응을 보였습니다. 전문가들은 이번 사태가 반려동물과 반려인 간의 신뢰 관계에 큰 파장을 일으킬 것으로 전망하고 있습니다. ";
