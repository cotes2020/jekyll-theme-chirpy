...
(function () {
    ...
    async function doSendOrRegenerate() {
        ...
        try {
            ...
            if (typeof Mdd !== 'undefined') { Mdd.setMood('happy'); Mdd.say('대답 완료다냥!'); }
        } catch (e) {
            ...
            if (e.message !== '요청이 취소되었습니다.') {
                ...
                if (typeof Mdd !== 'undefined') { Mdd.setMood('sad'); Mdd.say('에러다냥...'); }
            }
    ...
    window._cb = {
        ...
        clearChat: function () {
            ...
            if (typeof Mdd !== 'undefined') { Mdd.setMood('idle'); Mdd.say('새로 시작이다냥!'); }
        },
