(function () {
    ...
    function render(container) {
        ...
        let totalChat = 0, totalImage = 0, totalChatTokens = 0, totalImageTokens = 0;
        days.forEach(d => {
            const s = stats[d];
        ...
        container.querySelector('#dashRefresh').onclick = () => render(container);
        container.querySelector('#dashClear').onclick = () => {
