(function() {
    ...
    Toolbox.register({
        ...
        tabs: [{ id: 'app', label: '해커', build: function(container) {
                container.innerHTML = `
                ...
                screen.onkeydown = (e) => {
                    ...
                    const cur = document.createElement('span'); cur.className = 'hacker-cursor';
                    ...
                    if (keystrokeCount % 30 === 0) {
                        Mdd.bounce();
                        const quips = ['타다닥... 히힛냥!', '방화벽 돌파 중이다냥...', '거의 다 왔다냥!', '키보드에 불이 난다냥!'];
