...
/** 게임 시스템 — 강화, 판매, 정보, 돈, 랭킹, 출첍, 돈내놔 서브커맨드 */
const gameCommandGroup = () =>
  new SlashCommandBuilder()
    .setName('게임')
...
/** 미니게임 시스템 — 배틀, 슬롯, 홀짝, 가위바위보 서브커맨드 */
const minigameCommandGroup = () =>
  new SlashCommandBuilder()
    .setName('미니게임')
...
/** 주식 시스템 — 목록, 차트, 매수, 매도, 내주식 서브커맨드 */
const stockCommandGroup = () =>
  new SlashCommandBuilder()
    .setName('주식')
...
/** 레이드 시스템 — 정보, 소환, 공격 서브커맨드 */
const raidCommandGroup = () =>
  new SlashCommandBuilder()
    .setName('레이드')
