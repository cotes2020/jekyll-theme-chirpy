...
last_modified_at: 2026-02-22. 18:25 # +메모
---
...
- 카르다쇼프 척도
- Nazars
- 호랑이는 순우리말로 칡범, 갈범이라고 했는데
  - 저 떡 뺏어먹는 호랑이는 영조시절 오일장을 위해 미시령을 넘나들던 상인들에게 빈번하게 떡을 뺏어먹는다는 사실이 조선와조실록에 기록되어 있습니다.
  - 마을 뿐 아니라 조정에도 그 소문이 파다하게 퍼졌고, 후에 저 호랑이는 수시로 저런 짓을 벌인다 하여 상습범이라 불리게 되었다는 기록도 있네요.
...
- 파리가 조는 듯한 더위
- 고립감
  - 털어놓을 사람 없음(주변인이 자기한테 우호적인가랑 별개로 뭔갈 털어놓는 게 가능하지 않음)
  - 털어놔도 암것도 안 바뀔 듯 ㄷㄷ
...
- 포션: 레시피
- 마법: 주문서
- 연금술 : 약초 , 몬스터 부산물, 불 조절 (포션 크래프트 스타캐치)
- 사역마/ 펫 육성 (컬트램 추종자 관리, 스타듀밸리 목축업)
- 솜먼지, 슬라임
- 메니플 자섯펫? 머지? 먹깨비?(먼지, 쓰레기 (청소))
- 보상: 자동화? 귀여움?
- 별자리 관측
- 랜덤 버프? 별똥별?
- 스킨 (코스튬, 의상)
- 천, 거미줄, 염료
- 유물 복원, 도촬 (미녕시 콜렉션 같은, 로스트아크 뷰 같음)
- 이스터에크. 모코코
- 대역사시설, 문명 불가사의
- -> 쿠키런 보유효과 (전투)
- 마크 신호기 (버프 상시)
...
- 슬라임 젤리 소다
- 주문처리 미니게임
- 브금을 다 옛날 우리나라 곡 리메이크
  - 아리랑 섬그늘, 강상술래, 애국가
- 심시티 시청 ~ 부 ~ 부  (ex 환경부 교육부 관광부)
- 모닥불 ASMR 소리는 어떡하지?
- 10시간 노마이크 플레이 이런거
- 스토리 나폴리탄 괴담처럼 전달
- 연출로 한 방 때려주는 것이 필요 (Like 언더테일)
- 추리물: 결정적인 증거가 하나씩 나와서 어떤게 더 결정적인지를 따지는 것이 재밌다.
- 아홉수
- last_modified_at: 2026-04-06. 02:42
- 거대공포증 Megalophobia <https://youtu.be/R_MTqL0aPpc?si=aVq4xjOVYHoBqxvR>
- Low cortisol dance meme ( Agnes Tachyon )
- Incremental (Mining) <https://youtu.be/On2ggamuyFM?si=GfM7QqG5h3h054Ct>
- 아이러브커피 PC <https://youtu.be/OI6RA9w_Jrg?si=R-EKljKDMXB4EItU>

<https://youtu.be/VlpDKsHBNKY?si=gmmXidIn6DBEWWfs>

내 세계를 만들어가는 사람. WM 개발자. 몇 명의 팬을 보유한 사나이.  

감정 앵커링: '오늘 하루 끝에 어떤 나로 잠들고 싶은가?'라는 정체성 기반의 질문으로 내부 동기를 점화합니다.
핵심 요약: INFP는 휘발유가 아닌 '의미'를 연료로 움직이는 전기차와 같습니다. 효율이 아니라 자신의 가치와 정체성을 우선순위에 두는 방식이 진정한 실행력을 만듭니다.

70% 현실 필터(12:48): 완벽주의를 버리고 '70%만 완성하자'는 마음으로 시작의 문턱을 낮춥니다.
뇌의 본성 이해  
인간의 뇌는 장기적인 성취보다는 당장의 에너지 절약과 즉각적인 보상을 우선시하도록 진화했습니다. 따라서 의지력에 의존하는 것은 수백만 년 된 본능과 싸우는 것이며, 결국 실패할 확률이 높습니다.

환경 설계 (Choice Architecture) (6:30 - 10:20)
의지력은 약하지만 환경은 강력합니다. 좋은 습관을 만들고 싶다면 의지를 쥐어짜는 대신, 좋은 행동을 하기 쉬운 환경(예: 운동복 미리 꺼내두기, 휴대폰 멀리하기)을 조성해야 합니다.
마이크로 빅토리 설계: 2분 안에 끝낼 수 있는 아주 작은 행동(예: 운동복 입기)으로 시작 저항을 없애고 자이가르닉 효과를 활용합니다.
결정 피로 제로 시스템(10:40): 전날 밤에 다음 날 첫 행동과 물리적 환경을 미리 세팅합니다.
습관 쌓기 (Habit Stacking) (10:20 - 14:30)
이미 몸에 밴 습관(양치하기, 커피 마시기 등) 뒤에 새로운 행동을 붙이는 기술입니다. 이를 통해 뇌의 기존 회로를 활용하여 새로운 습관을 거부감 없이 시작할 수 있습니다.


감정일기 피드백 루프: 매일 밤 '가장 나다웠던 순간'을 기록하여 자기 효능감을 축적합니다.
소셜 어카운터빌리티(13:52): 믿을 수 있는 단 한 사람에게만 목표를 선언하여 실행력을 강화합니다.

감정 변동 대응 프로토콜(11:41): 일주일간 에너지 패턴을 기록하여, 에너지가 높을 때 창의적 작업을 배치합니다.

행동 변화의 4가지 법칙 (14:30 - 19:20)
습관을 형성하려면 다음 4단계를 설계해야 합니다:

분명하게 (Make it obvious): 행동을 시각적으로 눈에 띄게 배치하세요.
매력적으로 (Make it attractive): 하고 싶은 행동과 결합하세요.
쉽게 (Make it easy): 시작을 2분 이내의 아주 작은 행동으로 줄이세요.
만족스럽게 (Make it satisfying): 끝낸 즉시 작은 보상을 제공하세요.
정체성 변화 (23:20 - 27:12)
진정한 변화는 '결과'가 아니라 '정체성'에서 옵니다. 단순히 습관을 수행하는 사람이 아니라, 그 습관을 가진 '그런 사람'이 되겠다고 스스로 정의하고 사소한 행동으로 증명해 나갈 때 습관은 자동화됩니다.

결론: discipline(규율)은 강압이 아니라 설계입니다. motivation(동기)에 의존하지 말고, 시스템과 환경을 통해 원하는 행동이 '필연적'으로 일어나게 만드세요.

글쓰기: 생각하는 과정 그 자체입니다.
브레인 덤프: 머릿속 잡념이나 불안을 비워내는 작업 (그림이나 만화 활용도 가능).
저널링: 하루를 되돌아보고 감사함을 기록.
생각 카탈로그(Thought Catalog): 떠오르는 중요한 아이디어나 가치를 기록하여 자신의 관심사를 파악.
로그(Log): 게임, 책, 영상 등 미디어를 소비하며 느낀 나만의 내적 모험 기록.

앵커(Anchors) 리스트 작성: 정신적으로 힘들 때 나의 평온함을 되찾아주는 최소한의 기준을 정해두는 것입니다. (예: 3일 이상 집밥 먹기, 2일 이상 글쓰기 등)

새로운 기술과 취미에 대한 자유: 잘해야 한다는 압박 없이 순수한 호기심으로 새로운 활동(체스, 타로, 볼더링 등)을 시작하는 태도입니다.

신체 돌보기: 어떠한 야망도 건강보다 중요하지 않음을 깨닫고, 볼더링처럼 즐겁게 몸을 단련하는 활동을 지속하는 것입니다.

나쁜 습관 제거 (9:17-10:25): 나쁜 습관을 억지로 끊으려 하기보다, 좋은 습관의 비중을 점진적으로 늘려 자연스럽게 나쁜 습관을 대체하는 방식을 제안합니다.
실천 방법:
먼저 단 하나의 습관을 정해 일주일 동안 꾸준히 실천하고, 그 후 습관을 하나씩 덧붙여 나가는 방식을 권장합니다.

3. 죽음에 대하여 (Death): (7:37 - 12:50)
'오늘이 내 인생의 마지막 날이라면?'이라는 질문을 매일 아침 던지며 살았던 경험과, 췌장암 진단을 통해 죽음을 마주했던 순간을 이야기합니다. 죽음은 삶이 만든 가장 훌륭한 변화의 도구이며, 타인의 기대나 교조주의에 갇히지 말고 자신의 내면의 목소리에 귀를 기울여 진정으로 원하는 삶을 살라고 권고합니다.

MMD 한글자막 부탁해 달링 - 하츠네 미쿠 (Real Life Stage) <https://youtu.be/eS0oIfYQUys?si=4Xx7OqNytjSde_3i>
[이거 먹으려고 110시간 파밍했다면 믿으시겠습니까? 【 도감작 : 파란 달팽이·빨간 달팽이·스포아 】下](https://youtu.be/1mvqz4fuOGI?si=HCMjYqtAjKr_7k98)
[공간감은 어디서 오는가](https://youtu.be/G8DLSyr0zZU?si=enDCuxXF03xkpxga)



이 영상은 인디 게임 개발자가 야심 찬 프로젝트를 완성하거나 포기하지 않고, 제한된 범위(Scope) 내에서 성공적인 게임을 만들기 위한 '빼기 디자인(Subtractive Design)' 전략을 다루고 있습니다. 핵심은 개발자의 업무 부담을 줄이면서도 플레이어의 경험을 해치지 않는 집중력 있는 게임을 만드는 것입니다.

영상에서 제시하는 3가지 주요 전략은 다음과 같습니다:

캐릭터 최소화 (02:38 - 06:43)

캐릭터 애니메이션, 대사, 컨트롤 구현은 매우 많은 노력이 듭니다. 이를 줄이기 위해 캐릭터가 없는 환경(예: Gone Home, Portal)을 설정하거나, 자동차나 배 같은 이동 수단을 조종하게 하여 인물 애니메이션을 피하는 방식(Pacific Drive, Dredge)을 제안합니다.
더 작은 세계관과 레벨 디자인 (06:43 - 12:20)

대규모 오픈 월드는 레벨 디자인 팀이 필수적이지만, 인디 개발자에게는 현실적이지 않습니다. 대신 레벨을 아예 만들지 않거나, 같은 공간을 반복해서 활용하는 방식(예: '틀린 그림 찾기' 류 게임인 The Exit 8, Papers, Please)을 통해 자산 활용도를 극대화할 수 있습니다.
역학(Mechanic)의 단순화 (12:20 - 15:14)

거대한 장르의 요소를 모두 포함하려 하지 말고, 특정 메커니즘 하나에 집중하여 독창적인 서브 장르를 만듭니다. 예로, 인벤토리 관리 시스템만 극대화한 Backpack Hero나 타워 디펜스 게임 등이 있습니다.
결론:
성공적인 인디 게임은 단순히 짧은 게임이 아니라, 제한된 요소로 깊이 있는 경험을 설계한 게임입니다. 개발자는 자신의 창의적인 비전과 제작 가능한 실무적 한계를 고려하여, '무엇을 뺄 것인가'를 결정하는 것이 가장 중요합니다 (18:44 - 20:11).

3D 연출대신 블아처럼 텍스트 이미지 기반

[내가 수인이라면 어떤 수인? 판타지심리테스트 \[수인 편\]](https://youtu.be/z-F9QBxQ-BE?si=5wkfN_sLRUADuDXi)
Sokpop Collective 
[Tutorial: Rigging for lowpoly characters](https://youtu.be/cClmC4CyZRs?si=IL8hmbfhfPMq_INZ)
[토비 폭스가 UNDERTALE 음악을 작곡한 방법](https://youtu.be/LPCBm59yFfI?si=6i0lD9vqKHS_nToE)    
[INFP 실행력 높이는 법: 뇌과학이 증명한 인프피 전용 2분 전략"](https://youtu.be/VlpDKsHBNKY?si=9QwQnWwAE4YZE521)
