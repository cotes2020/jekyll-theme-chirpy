...
저는 AI 기반 애플리케이션 개발 및 자동화 프로세스 구축 경험을 바탕으로, 생성형 AI 서비스 개발에 기여하고 싶어 현대오토에버에 지원했습니다. 금융 IT 업계에서 AI를 활용한 테스트 자동화 프로젝트 및 다양한 연구를 진행해왔으나, 회사의 방침 변경으로 AI 관련 사업이 중단되면서 AI 소프트웨어 개발자로서의 성장을 이어갈 환경을 찾게 되었습니다.

저는 빠르게 변화하는 AI 기술 트렌드에 관심이 많으며, 생성형 AI 기술을 적극 활용하여 혁신을 만드는 데 기여하고 싶습니다. 현대오토에버는 H Chat을 비롯한 AI 기반 서비스 개발을 선도하며, 클라우드 네이티브 환경과 다양한 기술 스택을 활용하는 개발 문화를 보유하고 있어 저에게 최적의 환경이라고 생각합니다.
...
저는 실제 비즈니스 가치를 창출하는 AI 애플리케이션을 개발하고 싶습니다. AI 기반 애플리케이션 개발을 경험하며, 단순한 기술 구현이 아닌 비즈니스 문제를 해결하는 도구로서의 AI 활용이 중요함을 깨달았습니다. 저는 이를 바탕으로 생성형 AI 기반 서비스 개발 및 H Chat 서버 운영에 기여하고자 합니다.

1. AI 기반 서비스 개발 및 최적화 경험
   AI를 활용한 BDD 자동화 솔루션과 테스트 데이터 생성 솔루션을 개발하며, LLM의 한계를 극복하고 성능을 최적화하는 방법을 익혔습니다. 예를 들어, 초기에는 테스트 데이터 생성을 위해 각 필드마다 LLM을 호출했지만, Python 코드 템플릿을 자동 생성하도록 변경하여 LLM 호출을 단 한 번으로 줄이는 방식을 도입하였습니다. 이를 통해 비용 절감 및 속도 향상을 동시에 달성하였으며, 생성형 AI를 활용한 서비스 개발 시 최적화 전략을 적용할 수 있습니다.

2. 신규 애플리케이션 개발에 대한 인사이트
   생성형 AI를 서비스화하려면 기술적 완성도뿐만 아니라 사용자 입장에서의 유용성에 대한 고려가 필수적입니다. 저는 AI 기반 BDD 솔루션을 개발하며, ① 도입 저항감 ② 기존 시스템과의 통합 문제 등의 장애물을 경험했습니다. 이를 해결하기 위해 사용자 친화적인 인터페이스를 구축하고, 다양한 문서 포맷 지원을 추가하여 현업에서 쉽게 도입할 수 있도록 개선하였습니다. 이러한 경험을 바탕으로 실질적인 적용 가능성을 높이는 역할을 수행할 수 있습니다.

3. 다양한 기술 스택과 클라우드 환경 경험
   저는 Spring 기반 Java 백엔드 개발, 리액티브 프로그래밍(WebFlux), AWS 서버 인프라 구축 등의 다양한 기술 경험이 있습니다. LangChain 및 RAG 기반 AI 애플리케이션을 개발하였으며, AWS 환경에서 Docker 및 CI/CD를 활용한 배포까지 경험하였습니다. 따라서 생성형 AI 서비스를 개발할 뿐만 아니라 운영 및 확장성까지 고려한 백엔드 시스템을 구축할 수 있습니다.
