...
A.안녕하세요, 저는 AI Software Engineer 정예울입니다.

- 저는 새로운 지식을 배우고, 적용해보고, 더 좋은 방법을 고민하는 것을 좋아합니다.
- Langchain, 에이전트, 멀티 에어전트, AI 트렌트를 공부하며 미래에는 많은 것이 AI로 대체될 거라는 확신
- 본격적 공부 -> 사내에서 Langchain 강의 진행
- 두 개의 AI 어플리케이션 개발 경험 - ai 어플리케이션 개발 경험을 통해, ai 앱의 아키텍쳐, 프롬프트 관리, 응답 퀄리티 일관되고 높게 유지하는 방법 등에 대한 경험
- 그 전에는 spring 기반의 java 개발. - db 모델링, 프론트, 백엔드, cicd 구축, 서버작업, 기술문서 작업까지 일련의 과정 모두 경험
- 현재 한국의 AI 분야에서 가장 뛰어난 성장력을 가진 upstage에서 저의 AI software engineer로서의 커리서를 함께 성장하며 쌓아나가고 싶습니다.
...
- Upstage는 국내 최고의 LLM인 solar pro와 solar mini 모델을 가지고 있다.
- document parse를 통해 기업에서의 document 기반의 rag, qa 서비스에서 더 많은 정보를 획득하고, 정확도를 높일 수 있을 것.
- llm 어플리케이션을 개발하며 느낀 것-중요한 건 자체 모델을 갖고 있는 것 - 매우 비전이 있다고 생각!
